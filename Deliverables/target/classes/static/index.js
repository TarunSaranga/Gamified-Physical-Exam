...
function layerchange() {
    ...
    var filename = "https://apps.hdap.gatech.edu/gamified-physical-examination/bodies/body_" + layer.value + ".png";
...
function deleteRow(btn) {
    ...
    const examCode = row.firstElementChild.innerHTML;
...
$( function() {
    ...
    function addExam() {
        ...
        if (unit != examItem.unit) {
            ...
            popup.dialog( "close" );
        } else if (selectedCode[examItem.code] != null) {
            alert("Exam already selected!");
            popup.dialog( "close" );
        } else {
            selectedCode[examItem.code] = examItem;
            $( "#exam_list tbody" ).append( "<tr>" +
            "<td class='exam_code' style='display:none'>" + examItem.code + "</td>" +
            "<td class='exam_name'>" + examItem.name + "</td>" +
            "<td class='exam_measurement'>" + examItem.code + "</td>" +
